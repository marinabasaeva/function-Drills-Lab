...
const compareNums = (num1, num2) => {
  return num1 > num2 ? console.log (num1) 
...
nameParam === "Steven" ? "What is up Steven?" 
: nameParam === "Bryan" ? "Hey Bryan!"
: `Cool name, ${nameParam}`

let nameGreeting = nameCheck("Marina")
...
color === "red" ? "red is a great color"
...
*/
//CODE HERE
const thatsOdd = num => num % 2 === 0 ? "Thats not odd!" : "That is odd indeed!"
...
console.log(bestMovie("Inception"))
...
*/
//CODE HERE
const upperCaseString = string => console.log(string.toUpperCase())
...
*/
//CODE HERE
const frogsHunt = gold => gold / 3
let totalFrogs = frogsHunt(31)
...
*/
//CODE HERE
const frogsHunt2 = gold => gold / 3
let totalFrogs2 = Math.floor(frogsHunt2(31))
...
let arrayIsAscending = myFunc(sampleArray)
